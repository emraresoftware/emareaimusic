# Emare AI Music — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/emareaimusic
...
| 6 | `emareaimusic_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `emareaimusic Dervishi` bu projeden sorumlu
