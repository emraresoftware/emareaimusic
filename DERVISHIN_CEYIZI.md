# Emare AI Music — Dervişin Çeyizi
...
```python
# Emare AI Music — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emareaimusic.view',      # Görüntüleme
    'emareaimusic.create',    # Oluşturma
    'emareaimusic.edit',      # Düzenleme
    'emareaimusic.delete',    # Silme
    'emareaimusic.manage',    # Tam yönetim
    # Admin
    'emareaimusic.admin',     # Admin panele erişim
    'emareaimusic.users',     # Kullanıcı yönetimi
    'emareaimusic.settings',  # Ayar yönetimi
]
```
...
```python
# emareaimusic/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emareaimusic.view', 'emareaimusic.create',
        'emareaimusic.edit', 'emareaimusic.delete',
        'emareaimusic.manage', 'emareaimusic.users',
        'emareaimusic.settings', 'emareaimusic.admin',
    },
    'operator': {
        'emareaimusic.view', 'emareaimusic.create',
        'emareaimusic.edit',
...
| Proje Admini | admin@emareaimusic.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emareaimusic.emare.dev | super_admin | Machine-to-machine |
